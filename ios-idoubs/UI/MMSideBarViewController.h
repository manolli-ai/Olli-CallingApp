...
@class MMSideBarViewController ;

@protocol MMSideBarDelegate <NSObject>
@optional
- (void)sidebar:(MMSideBarViewController *)sidebar willShowOnScreenAnimated:(BOOL)animatedYesOrNo;
- (void)sidebar:(MMSideBarViewController *)sidebar didShowOnScreenAnimated:(BOOL)animatedYesOrNo;
- (void)sidebar:(MMSideBarViewController *)sidebar willDismissFromScreenAnimated:(BOOL)animatedYesOrNo;
- (void)sidebar:(MMSideBarViewController *)sidebar didDismissFromScreenAnimated:(BOOL)animatedYesOrNo;
...
@interface MMSideBarViewController : UIViewController
...
@property (nonatomic, weak) id <MMSideBarDelegate> delegate;
